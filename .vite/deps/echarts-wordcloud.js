...
if (!window.clearImmediate) {
  window.clearImmediate = (function setupClearImmediate() {
    return (
      ...
      window.oClearImmediate || // "clearZeroTimeout" is implement on the previous block ||
      // fallback
...
var WordCloud = function WordCloud2(elements, options) {
  ...
  var exceedTime = function exceedTime2() {
    return (
      ...
      /* @__PURE__ */ new Date().getTime() - escapeTime > settings.abortThreshold
    )
  }
...
registerLayout(function (ecModel, api) {
  ecModel.eachSeriesByType('wordCloud', function (seriesModel) {
    var gridRect = helper_exports.getLayoutRect(seriesModel.getBoxLayoutParams(), {
      width: api.getWidth(),
        ...
        .mapArray('value', function (value, idx) {
          ...
          return [
            ...
            itemModel.get('textStyle.fontSize', true) ||
              number_exports.linearMap(value, valueExtent, sizeRange),
            idx
          ]
        })
        .sort(function (a, b) {
...
registerPreprocessor(function (option) {
  ...
  function compatTextStyle(textStyle) {
    textStyle &&
      util_exports.each(compats, function (key) {
