...
// node_modules/.pnpm/@vueuse+shared@12.3.0_typescript@5.7.3/node_modules/@vueuse/shared/index.mjs
...
// node_modules/.pnpm/@vueuse+core@12.3.0_typescript@5.7.3/node_modules/@vueuse/core/index.mjs
...
function useElementVisibility(element, options = {}) {
  const { window: window2 = defaultWindow, scrollTarget, threshold = 0, rootMargin } = options
...
function useSpeechRecognition(options = {}) {
  ...
  let recognition
  const start = () => {
    if (!isListening.value) recognition == null ? void 0 : recognition.start()
  }
  const stop = () => {
    if (isListening.value) recognition == null ? void 0 : recognition.stop()
  }
