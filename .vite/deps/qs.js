...
var require_formats = __commonJS({
  'node_modules/.pnpm/qs@6.13.1/node_modules/qs/lib/formats.js'(exports, module) {
    'use strict'
    var replace = String.prototype.replace
...
var require_utils = __commonJS({
  'node_modules/.pnpm/qs@6.13.1/node_modules/qs/lib/utils.js'(exports, module) {
    'use strict'
    ...
    var encode = function encode2(str, defaultEncoder, charset, kind, format) {
      ...
      for (var j = 0; j < string.length; j += limit) {
        ...
        for (var i = 0; i < segment.length; ++i) {
          ...
          if (c < 55296 || c >= 57344) {
            arr[arr.length] =
              hexTable[224 | (c >> 12)] + hexTable[128 | ((c >> 6) & 63)] + hexTable[128 | (c & 63)]
            continue
          }
          i += 1
...
var require_stringify = __commonJS({
  'node_modules/.pnpm/qs@6.13.1/node_modules/qs/lib/stringify.js'(exports, module) {
    'use strict'
    ...
    var stringify = function stringify2(
      ...
      for (var j = 0; j < objKeys.length; ++j) {
        var key = objKeys[j]
        var value =
          typeof key === 'object' && key && typeof key.value !== 'undefined' ? key.value : obj[key]
        if (skipNulls && value === null) {
          continue
        }
        var encodedKey =
          allowDots && encodeDotInKeys ? String(key).replace(/\./g, '%2E') : String(key)
...
var require_parse = __commonJS({
  'node_modules/.pnpm/qs@6.13.1/node_modules/qs/lib/parse.js'(exports, module) {
    'use strict'
    var utils = require_utils()
    var has = Object.prototype.hasOwnProperty
    var isArray = Array.isArray
    ...
    var normalizeParseOptions = function normalizeParseOptions2(opts) {
      ...
      var duplicates =
        typeof opts.duplicates === 'undefined' ? defaults.duplicates : opts.duplicates
      ...
      return {
        ...
        depth:
          typeof opts.depth === 'number' || opts.depth === false ? +opts.depth : defaults.depth,
        duplicates,
        ...
        strictDepth:
          typeof opts.strictDepth === 'boolean' ? !!opts.strictDepth : defaults.strictDepth,
        strictNullHandling:
          typeof opts.strictNullHandling === 'boolean'
            ? opts.strictNullHandling
            : defaults.strictNullHandling
...
var require_lib = __commonJS({
  'node_modules/.pnpm/qs@6.13.1/node_modules/qs/lib/index.js'(exports, module) {
